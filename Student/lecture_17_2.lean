...
| Or.inl a, Or.inl b => False.elim (nab ⟨ a, b ⟩) --if both are false, anything follows
--I couldn't figure out how to write this line at first so I asked Bing AI.
| Or.inl a, Or.inr nb => Or.inr nb -- T F -> ¬B
| Or.inr na, Or.inl b => Or.inl na -- F T -> ¬A
| Or.inr na, Or.inr nb => Or.inl na -- F F -> ¬A (¬A is enough)
